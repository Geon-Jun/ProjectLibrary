...
import com.project.library.adapters.viewholders.MemberViewHolder;
import com.project.library.databinding.ItemMemberBinding;
import com.project.library.models.Member;
import com.project.library.retrofit.APIClient;
...
import com.project.library.utils.Alert;
import com.project.library.utils.AlertDialogBuilderUtil;
import com.project.library.utils.SimpleCallbackUtil;
...
public class MemberRecyclerViewAdapter extends RecyclerView.Adapter<MemberViewHolder> {
    ...
    public void onUpdateBtnClick(View view, final Member item) {
        AlertDialogBuilderUtil.doubleEditTextDialog(view.getContext(), "주민 수정",
                "변경할 마을 주민 정보를 입력해주세요", new String[]{item.getName(), item.getContacts()},
                new String[]{"주민 이름", "주민 연락처"}, new AlertDialogBuilderUtil.DoubleEditTextListener() {
                    @Override
    ...
    public void onDeleteBtnClick(View view, final Member item) {
        AlertDialogBuilderUtil.simpleDialog(view.getContext(), "주민 삭제",
